...
- Avg. Residual Force  = 9.37 N
- Avg. Residual Torque = 46.46 N-m

Automatic processing found a new model mass to achieve dynamic
consistency:

  - Total mass = 70.09 kg (+1.20% change from original 69.26 kg)

Individual body mass changes:

  - pelvis    mass = 10.86 kg (+0.03% change from original 10.85 kg)
  - femur_r   mass = 7.89 kg (-7.94% change from original 8.57 kg)
  - tibia_r   mass = 2.83 kg (-17.18% change from original 3.42 kg)
  - talus_r   mass = 2.06 kg (+2136.44% change from original 0.09 kg)
  - calcn_r   mass = 0.78 kg (-32.59% change from original 1.15 kg)
  - toes_r    mass = 0.00 kg (-99.30% change from original 0.20 kg)
  - femur_l   mass = 7.89 kg (-7.94% change from original 8.57 kg)
  - tibia_l   mass = 2.83 kg (-17.18% change from original 3.42 kg)
  - talus_l   mass = 2.06 kg (+2136.44% change from original 0.09 kg)
  - calcn_l   mass = 0.78 kg (-32.59% change from original 1.15 kg)
  - toes_l    mass = 0.00 kg (-99.30% change from original 0.20 kg)
  - torso     mass = 24.30 kg (-1.71% change from original 24.72 kg)
  - humerus_r mass = 1.85 kg (-1.02% change from original 1.87 kg)
  - ulna_r    mass = 0.62 kg (+10.30% change from original 0.56 kg)
  - radius_r  mass = 0.62 kg (+10.30% change from original 0.56 kg)
  - hand_r    mass = 0.82 kg (+95.18% change from original 0.42 kg)
  - humerus_l mass = 1.85 kg (-1.02% change from original 1.87 kg)
  - ulna_l    mass = 0.62 kg (+10.30% change from original 0.56 kg)
  - radius_l  mass = 0.62 kg (+10.30% change from original 0.56 kg)
  - hand_l    mass = 0.82 kg (+95.18% change from original 0.42 kg)

The following trials were processed to perform automatic body scaling,
marker registration, and residual reduction:

trial: run400
  - Avg. Marker RMSE      = 1.53 cm
  - Avg. Marker Max Error = 4.55 cm
  - Avg. Residual Force   = 12.52 N
  - Avg. Residual Torque  = 52.59 N-m
...
trial: run200
  ...
  - Avg. Marker Max Error = 3.66 cm
  - Avg. Residual Force   = 3.12 N
  - Avg. Residual Torque  = 28.39 N-m
  --> See IK/run200_ik_summary.txt and ID/run200_id_summary.txt for more details.

trial: run300
  - Avg. Marker RMSE      = 1.32 cm
  - Avg. Marker Max Error = 3.85 cm
  - Avg. Residual Force   = 9.57 N
  - Avg. Residual Torque  = 37.83 N-m
  --> See IK/run300_ik_summary.txt and ID/run300_id_summary.txt for more details.

trial: run500
  - Avg. Marker RMSE      = 1.55 cm
  - Avg. Marker Max Error = 3.75 cm
  - Avg. Residual Force   = 15.90 N
  - Avg. Residual Torque  = 76.14 N-m
...
FOLDER, and not including the leading "> "):
 ...
 > opensim-cmd run-tool run400_id_setup.xml
           # This will create results on time range (0.78s to 2.85s) in file ID/run400_osim_id.sto
 > opensim-cmd run-tool run200_id_setup.xml
           # This will create results on time range (1.15s to 4.77s) in file ID/run200_osim_id.sto
 > opensim-cmd run-tool run300_id_setup.xml
           # This will create results on time range (0.44s to 2.58s) in file ID/run300_osim_id.sto
 > opensim-cmd run-tool run500_id_setup.xml
           # This will create results on time range (2.06s to 4.45s) in file ID/run500_osim_id.sto
