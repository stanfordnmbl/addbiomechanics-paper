...
def fillAndCopySubjectJSON(argv):
    # Should we run the dynamics fitting step?
    disableDynamics = argv[1].lower() == 'false'
    ...
    for subject, mass, height in zip(subjects, masses, heights):
        ...
        data['massKg'] = mass
        data['heightM'] = height
        data['disableDynamics'] = disableDynamics
...
if __name__ == "__main__":
    fillAndCopySubjectJSON(sys.argv)