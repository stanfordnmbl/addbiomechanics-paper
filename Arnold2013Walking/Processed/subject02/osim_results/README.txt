...
- Avg. Marker RMSE      = 0.67 cm
- Avg. Max Marker Error = 1.54 cm
...
consistency:
  ...
  - Total mass = 76.45 kg (-0.04% change from original 76.48 kg)

Individual body mass changes:

  - pelvis    mass = 10.71 kg (-1.82% change from original 10.91 kg)
  - femur_r   mass = 8.52 kg (-1.09% change from original 8.61 kg)
  - tibia_r   mass = 3.42 kg (-0.40% change from original 3.43 kg)
  - talus_r   mass = 0.17 kg (+84.03% change from original 0.09 kg)
  - calcn_r   mass = 1.26 kg (+9.01% change from original 1.16 kg)
  - toes_r    mass = 0.37 kg (+84.40% change from original 0.20 kg)
  - femur_l   mass = 8.52 kg (-1.09% change from original 8.61 kg)
  - tibia_l   mass = 3.42 kg (-0.40% change from original 3.43 kg)
  - talus_l   mass = 0.17 kg (+84.03% change from original 0.09 kg)
  - calcn_l   mass = 1.26 kg (+9.01% change from original 1.16 kg)
  - toes_l    mass = 0.37 kg (+84.40% change from original 0.20 kg)
  - torso     mass = 31.50 kg (-0.65% change from original 31.71 kg)
  - humerus_r mass = 1.83 kg (-2.88% change from original 1.88 kg)
  - ulna_r    mass = 0.56 kg (+0.09% change from original 0.56 kg)
  - radius_r  mass = 0.56 kg (+0.09% change from original 0.56 kg)
  - hand_r    mass = 0.42 kg (-0.69% change from original 0.42 kg)
  - humerus_l mass = 1.83 kg (-2.88% change from original 1.88 kg)
  - ulna_l    mass = 0.56 kg (+0.09% change from original 0.56 kg)
  - radius_l  mass = 0.56 kg (+0.09% change from original 0.56 kg)
  - hand_l    mass = 0.42 kg (-0.69% change from original 0.42 kg)
...
FOLDER, and not including the leading "> "):
 ...
 > opensim-cmd run-tool walk2_id_setup.xml
           # This will create results on time range (3.085s to 4.245s) in file ID/walk2_osim_id.sto
