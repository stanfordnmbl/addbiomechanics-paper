...
- Avg. Marker RMSE      = 0.68 cm
- Avg. Max Marker Error = 1.76 cm
...
- Avg. Residual Force  = 0.20 N
- Avg. Residual Torque = 0.23 N-m

Automatic processing found a new model mass to achieve dynamic
consistency:

  - Total mass = 64.06 kg (-0.04% change from original 64.09 kg)

Individual body mass changes:

  - pelvis    mass = 9.12 kg (-0.23% change from original 9.14 kg)
  - femur_r   mass = 7.22 kg (-0.04% change from original 7.22 kg)
  - tibia_r   mass = 2.89 kg (+0.51% change from original 2.88 kg)
  - talus_r   mass = 0.07 kg (-3.39% change from original 0.08 kg)
  - calcn_r   mass = 0.98 kg (+0.90% change from original 0.97 kg)
  - toes_r    mass = 0.18 kg (+6.55% change from original 0.17 kg)
  - femur_l   mass = 7.22 kg (-0.04% change from original 7.22 kg)
  - tibia_l   mass = 2.89 kg (+0.51% change from original 2.88 kg)
  - talus_l   mass = 0.07 kg (-3.39% change from original 0.08 kg)
  - calcn_l   mass = 0.98 kg (+0.90% change from original 0.97 kg)
  - toes_l    mass = 0.18 kg (+6.55% change from original 0.17 kg)
  - torso     mass = 26.54 kg (-0.11% change from original 26.57 kg)
  - humerus_r mass = 1.57 kg (-0.51% change from original 1.58 kg)
  - ulna_r    mass = 0.48 kg (+1.32% change from original 0.47 kg)
  - radius_r  mass = 0.48 kg (+1.32% change from original 0.47 kg)
  - hand_r    mass = 0.33 kg (-6.26% change from original 0.36 kg)
  - humerus_l mass = 1.57 kg (-0.51% change from original 1.58 kg)
  - ulna_l    mass = 0.48 kg (+1.32% change from original 0.47 kg)
  - radius_l  mass = 0.48 kg (+1.32% change from original 0.47 kg)
  - hand_l    mass = 0.33 kg (-6.26% change from original 0.36 kg)
...
FOLDER, and not including the leading "> "):
 ...
 > opensim-cmd run-tool walk2_id_setup.xml
           # This will create results on time range (2.445s to 3.505s) in file ID/walk2_osim_id.sto
